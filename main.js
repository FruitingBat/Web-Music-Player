...
document.addEventListener('DOMContentLoaded', function(){
  ...
  wavesurfer.on('loading', function (){ //Display loading message when music is loading
    document.getElementById("musicStatus").innerHTML = "Loading";
  });

  wavesurfer.on('ready', function (){ //Play music after it has loaded
    wavesurfer.play();
  });

  document.getElementById("playPauseButton").addEventListener("click", function(){ //Toggle playback of music when button clicked
    wavesurfer.playPause();
  });

  wavesurfer.on('play', function (){ //Display playback status as Playing and change playPauseButton text
    document.getElementById("musicStatus").innerHTML = "Playing";
    document.getElementById("playPauseButton").innerHTML = "||";
  });

  wavesurfer.on('pause', function (){ //Display playback status as Paused and change playPauseButton text
    document.getElementById("musicStatus").innerHTML = "Paused";
    document.getElementById("playPauseButton").innerHTML = "|>";
  });
});
